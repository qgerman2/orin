...
namespace cupqc {
    namespace detail {
        ...
        class pqc_block_execution: public pqc_execution<Operators...>
        {
            ...
            // Merkle Size  
            // * Default value: 2048
            static constexpr bool has_merkle_size = has_operator<operator_type::merkle_size, base_type>::value;
            using default_pqc_merkle_size = MerkleSize<2048>;
            using this_pqc_merkle_size = get_or_default_t<operator_type::merkle_size, base_type, default_pqc_merkle_size>;
            static constexpr auto this_merkle_size_v = this_pqc_merkle_size::value;
        ...
        public:
            ...
            static constexpr auto MerkleSize = this_merkle_size_v;
        ...
        public:
            ...
            template<class this_t = this_type, class Hash>
            inline __device__ auto generate_tree(const typename this_type::this_pqc_precision_t* leaves, Hash& hash,
                                                 tree<this_type::this_merkle_size_v, Hash, typename this_type::this_pqc_precision_t>& merkle)
                -> merkle_enable_if_t<this_t, function::Merkle> {
                return database::generate_tree<this_type::this_merkle_size_v, Hash, this_type::this_pqc_precision_t>(leaves, hash, merkle);
            }

            template<class this_t = this_type, class Hash>
            inline __device__ auto generate_proof(proof<this_type::this_merkle_size_v, Hash, typename this_type::this_pqc_precision_t>& proof,
                                                  const typename this_type::this_pqc_precision_t* proof_leaf, const uint32_t leaf_index,
                                                  const tree<this_type::this_merkle_size_v, Hash, typename this_type::this_pqc_precision_t>& merkle)
                -> merkle_enable_if_t<this_t, function::Merkle> {
                return database::generate_proof<this_type::this_merkle_size_v, Hash, this_type::this_pqc_precision_t>(proof, proof_leaf, leaf_index, merkle);
            }

            template<class this_t = this_type, class Hash>
            inline __device__ auto verify_proof(const proof<this_type::this_merkle_size_v, Hash, typename this_type::this_pqc_precision_t>& proof,
                ...
                return database::verify_proof<this_type::this_merkle_size_v, Hash, this_type::this_pqc_precision_t>(proof, verify_leaf, leaf_index, root, hash);
            }
        };
